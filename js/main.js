...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const bentoData = [
    ...
    { id: "love-core", title: "Love", subtitle: "Our precious memories, timeline & stories ❤️", icon: "heart", gridClass: "md:col-span-1 md:row-span-1", route: "love/index.html", glow: "rgba(244, 63, 94, 0.25)", iconColor: "text-neon-rose" },
